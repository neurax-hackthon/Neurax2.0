...
export const highlightCategories = [
  {
    ...
    images: [
      // Example: { src: '/neurax2/highlights/opening-ceremony.jpg', caption: 'Opening Ceremony' },
    ],
  },
  {
    id: 'winners',
  ...
  },
  {
    ...
    images: [
      { src: '/neurax2/participants/20260314_100831.heic', caption: 'Hard at work' },
      { src: '/neurax2/participants/audit_04.heic', caption: 'Innovation Hub' },
      { src: '/neurax2/participants/coding_02.heic', caption: 'The Grind' },
      { src: '/neurax2/participants/coding_room.heic', caption: 'Coding Session' },
      { src: '/neurax2/participants/coding_room_01.heic', caption: 'Mid-Hack Hustle' },
    ],
  },
  {
    id: 'organizing-team',
    ...
    images: [
      ...
      { src: '/neurax2/organizing-team/neurax_in_02.HEIC', caption: 'Org Core' },
      { src: '/neurax2/organizing-team/neurax_in_03 (2).heic', caption: 'Mission Success' },
    ],
  },
];
